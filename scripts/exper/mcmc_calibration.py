...
(Metropolis n_warmup, Gibbs n_sweeps, SA cooling length) at the exact
fig10c cell (h=0.5, lr=0.08, reg=0.05, ns=200, iterations=100), N=32 only.
...
collide with or be swept into the production Metropolis/Gibbs series:
