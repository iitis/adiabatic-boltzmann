...
All plots are saved to --output (default: plots/training_diagnostics/).
The script handles old JSON files (missing ess/kl/sampling_time) gracefully.

Usage:
    python scripts/plot_training_diagnostics.py
    python scripts/plot_training_diagnostics.py --model 1d --h 1.0
    python scripts/plot_training_diagnostics.py --size 16 --output plots/training_diagnostics/
"""
...
def main():
    ...
    parser.add_argument("--output",  type=Path, default=_root / "plots" / "training_diagnostics",
