#!/usr/bin/env python3
"""
Analyze results/sbm_tune.json — produced by scripts/sbm_tune.py.
Run from repo root:  python scripts/analyze_sbm_tune.py
Plots saved to:      plots/sbm_tune/
"""
