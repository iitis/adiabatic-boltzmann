...
def main():
    ...
    parser.add_argument("--size", type=int, default=None,
                        help="Filter grid to this size only (1D chain length or 2D linear dim)")
    parser.add_argument("--h", type=float, default=None,
                        help="Filter grid to this transverse field value only")
    parser.add_argument("--lr", type=float, default=None,
                        help="Filter grid to this learning rate only")
    parser.add_argument("--model", choices=["1d", "2d"], default=None,
                        help="Filter grid to this model only")
