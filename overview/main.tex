...
\begin{figure}[htbp]
  ...
  \vspace{-0.4em}\\
  \small\textit{Mean energy error per spin at convergence (top) and time to convergence
  (bottom) vs.\ $N$, for $h\in\{0.5,1.0,2.0\}$.
  Convergence: CV\,$<$\,0.1\% over 20 iterations.}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \vspace{-0.4em}\\
  \small\textit{Energy error (left) and time to convergence (right) vs.\ $h$,
  Metropolis sampler.
